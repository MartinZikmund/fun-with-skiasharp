...
// Headless representative-frame renderer. Invoked via:  SpiroHarmonograph.exe --thumb out.png
...
internal static class Thumb
{
    public static void Render(string path)
    {
        ...
        // Advance enough frames to reveal a near-complete, intricate figure.
        // DrawSpeed reveals ~165 samples/sec; ~31s of 60fps frames fills the curve.

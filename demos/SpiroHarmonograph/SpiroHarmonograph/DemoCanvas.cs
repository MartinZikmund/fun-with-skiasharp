...
public partial class DemoCanvas : SKCanvasElement
{
    ...
    // Driven by the Fluent overlay controls in MainPage.
    public void Randomize() => _scene.Reset();
    public void Clear() => _scene.Clear();
    public void SetDamping(double scale) => _scene.SetDamping((float)scale);
    public double Damping => _scene.Damping;

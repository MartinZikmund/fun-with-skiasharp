...
public sealed partial class MainPage : Page
{
    ...
    private void OnClear(object sender, Microsoft.UI.Xaml.RoutedEventArgs e) => Canvas.Clear();

    private void OnDampingChanged(object sender, RangeBaseValueChangedEventArgs e) => Canvas.SetDamping(e.NewValue);
